...
#twas_file <- '/cluster/work/pausch/naveen/TWAS/expression/SprediXcan/additive/fbkall/testis/result_with_cords.txt.gz'
#maf_thresh <- 0.005
#thresh_line <- 6
...
cat ('the minimum pvalues are', min(res[,pcol],na.rm=TRUE), min(res$twas,na.rm=TRUE), "\n" )
