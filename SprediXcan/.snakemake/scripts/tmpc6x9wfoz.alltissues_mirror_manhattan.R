...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', 'walltime', "mem_mb" = 8000, "mem_mib" = 7630, "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/scratch/257319577.tmpdir', "walltime" = '01:00'),
...
##dim (xres)
plot (res$newpos, -log10(res[, pcol]), col=res$mycol, xaxt="n", ylab=expression (-log [10](italic("P"))), ylim=ylims, cex.main=1 , cex.lab=fontsize, cex.axis=1, xlab="", pch=20, cex=1.5,yaxt="n", main='')
...
for (ti in 1:length (tissues) ) {
    ...
    points (mytissue$newpos, -1*-log10(mytissue[,5]), col=mytissue$mycol, xaxt="n", ylab=expression (-log [10](italic("P"))), ylim=ylims, cex.main=1 , cex.lab=fontsize, cex.axis=1, xlab="", pch=20, cex=1.5,yaxt="n", main='')
