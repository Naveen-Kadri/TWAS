...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', 'walltime', "mem_mb" = 6000, "mem_mib" = 5723, "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/scratch/257441535.tmpdir', "walltime" = '48:00'),
