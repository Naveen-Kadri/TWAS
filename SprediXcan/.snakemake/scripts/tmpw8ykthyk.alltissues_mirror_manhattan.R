...
snakemake <- Snakemake(
    ...
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', 'walltime', "mem_mb" = 8000, "mem_mib" = 7630, "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/scratch/257326024.tmpdir', "walltime" = '01:00'),
