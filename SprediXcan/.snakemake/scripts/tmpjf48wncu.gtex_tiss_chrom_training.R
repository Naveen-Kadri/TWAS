...
snakemake <- Snakemake(
    input = list('/cluster/work/pausch/naveen/TWAS/GENO/CHR1/snp_annotation.txt', '/cluster/work/pausch/naveen/TWAS/GENO/CHR1/genotypes.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/annotation.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/covariates.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/mpheno.txt', "snp_annotation" = '/cluster/work/pausch/naveen/TWAS/GENO/CHR1/snp_annotation.txt', "genotypes" = '/cluster/work/pausch/naveen/TWAS/GENO/CHR1/genotypes.txt', "gene_annotation" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/annotation.txt', "covariates" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/covariates.txt', "mpheno" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/mpheno.txt'),
    output = list('/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/summary.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/weights.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/tiss_summ.txt', '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/covariance.txt', "model_summary_file" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/summary.txt', "weights_file" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/weights.txt', "tiss_chr_summ_f" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/tiss_summ.txt', "covariance_file" = '/cluster/work/pausch/naveen/TWAS/splicing/vas_d/CHR1/covariance.txt'),
    params = list(),
    wildcards = list('splicing', 'vas_d', '1', "mpheno" = 'splicing', "tissue" = 'vas_d', "chr" = '1'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', 'walltime', "mem_mb" = 6000, "mem_mib" = 5723, "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/scratch/257441174.tmpdir', "walltime" = '48:00'),
